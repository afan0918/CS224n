...
class ParserModel(nn.Module):
    ...
    def forward(self, w):
        ...
        # hidden layer
        hidden_activations = F.relu(x.mm(self.embed_to_hidden_weight) + self.embed_to_hidden_bias)
        logits = hidden_activations.mm(self.hidden_to_logits_weight) + self.hidden_to_logits_bias
...
if __name__ == "__main__":
    ...
    if True:  # args.embedding:
        check_embedding()
        print("Embedding_lookup sanity check passes!")

    if True:  # args.forward:
        check_forward()
