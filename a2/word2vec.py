...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    # 拿出中心詞 index and vector
    centerWordIdx = word2Ind[currentCenterWord]
    centerWordVec = centerWordVectors[centerWordIdx]

    # 遍歷 context windows 內的每個外部詞
    for outsideWord in outsideWords:
        # 算當前外部詞的損失和梯度
        outsideWordIdx = word2Ind[outsideWord]
        curr_loss, curr_gradCenterVec, curr_gradOutsideVecs = word2vecLossAndGradient(centerWordVec, outsideWordIdx,
        ...
        # 累計外部詞向量的梯度
        gradOutsideVectors += curr_gradOutsideVecs
    ### END YOUR CODE
